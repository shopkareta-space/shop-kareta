        ...
        <motion.div variants={fadeUp} className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          {orderId ? (
            ...
            <motion.button
              whileTap={{ scale: 0.98 }}
              transition={premiumSpring}
              className="w-full sm:w-auto h-14 px-8 bg-white border-2 border-brand-gray/20 text-brand-blue rounded-full font-medium flex items-center justify-center gap-2 hover:border-brand-blue transition-colors opacity-50 cursor-not-allowed"
            >
              <Package className="w-4 h-4" />
              <span>Track Order</span>
            </motion.button>
